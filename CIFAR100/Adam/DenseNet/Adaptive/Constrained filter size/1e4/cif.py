...
optimizer = Adam(lr=1e-3, decay=0.) # Using Adam instead of SGD to speed up training
...
# Load model
save_dir = "."
model_name = 'epoch-noreg-{epoch:03d}.h5'
...
model.save('epoch-noreg-300-densenet-k12.h5')
