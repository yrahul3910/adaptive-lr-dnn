...
def lr_schedule(epoch):
    ...
    K_ = (99. * Kz) / (100. * batch_size) + 1e-4 * max_wt  # 128 = Batch size
    lr = 1 / K_
    lrs.append(lr)
...
model.compile(loss='categorical_crossentropy',
              optimizer=SGD(1e-3, decay=1e-4),  # we will compute this later
              metrics=['accuracy'])
...
fit(300)
model.save('epoch-300-resnet56-v2.h5')
